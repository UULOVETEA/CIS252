...
--
--  Fill in the blank so that fourteen evaluates to 25:
...
--
--  Fill in the blank so that fifteen evaluates to True: 
...
--
--  Fill in the blanks so that sixteen evaluates to 49:
